export default function FooterBackgroundSvg({ className }: { className?: string }) {
  return (
    <svg width="100%" viewBox="0 0 644 1153" fill="none" xmlns="http://www.w3.org/2000/svg" data-footer-svg="" data-svg-stagger="" data-svg-trigger=".footer_main-wrap" className={className}>
