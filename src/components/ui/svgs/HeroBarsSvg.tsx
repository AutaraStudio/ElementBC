export default function HeroBarsSvg({ className }: { className?: string }) {
  return (
    <svg width="100%" viewBox="0 0 988 93" fill="none" xmlns="http://www.w3.org/2000/svg" data-svg-stagger="" className={className}>
