export default function AboutHeroBackgroundSvg({ className }: { className?: string }) {
  return (
    <svg width="100%" viewBox="0 0 644 1153" fill="none" xmlns="http://www.w3.org/2000/svg" data-svg-stagger="" data-anim-hero="" data-svg-delay="0.5" className={className}>
