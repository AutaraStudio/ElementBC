export default function NavBackgroundSvg({ className }: { className?: string }) {
  return (
    <svg width="100%" viewBox="0 0 934 769" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
