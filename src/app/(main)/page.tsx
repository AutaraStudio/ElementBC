    ...
    <div className="page_main">
      ...
      <div data-hero-wrap="" className="home_hero_featured-wrap">
        <div data-hero-featured="list" role="list" className="home_hero_featured-list u-min-height-screen">
          <div data-hero-item="" role="listitem" className="home_hero_featured-item u-cover-absolute u-theme-dark">
            ...
            <div data-overlay-dark="" className="home_hero_featured_img-wrap u-cover-absolute">
              <Image
                ...
                fill
                loading="lazy"
                // @ts-expect-error data attribute forwarded to underlying img
                data-hero-img="primary"
                alt=""
      ...
      <section className="home_about-wrap u-theme-buff">
        <div data-wf--spacer--variant="large" className="u-section-spacer w-variant-8cc18b30-4618-8767-0111-f6abfe45aaa3 u-ignore-trim"></div>
            ...
            <div className="home_about-col u-column-span-12 u-grid-subgrid">
              <div className="home_about_col-inner u-column-span-5 u-flex-vertical-nowrap u-justify-content-between u-gap-6">
                ...
                <div className="home_about_svg-wrap">
                  ...
                  <svg width="100%" viewBox="0 0 536 606" fill="none" xmlns="http://www.w3.org/2000/svg" data-svg-stagger="" className="global_svg">
